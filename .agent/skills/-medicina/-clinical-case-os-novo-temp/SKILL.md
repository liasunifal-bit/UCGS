...
### Alternative Template: Interactive Flowchart with Tooltips

Use this template when the mechanism involves branching paths, interconnected concepts, or when the user specifically requests a flowchart or diagram with hover tooltips.
...
<style>
  :root {
    --bg-page: #eef7f2;
    --text-main: #1f3b2b;
    --box-purple-bg: #f2eefa; --box-purple-border: #534ab7;
    --box-orange-bg: #fdf2e3; --box-orange-border: #d48e3a;
    --box-pink-bg: #fcebeb; --box-pink-border: #d65a5a;
    --box-green-bg: #e4f3eb; --box-green-border: #2e8b57;
    --arrow-color: #557b6d;
  }
  .svg-container { width: 100%; margin-bottom: 20px; overflow: visible; }
  .node { cursor: pointer; transition: filter 0.2s; }
  .node:hover { filter: brightness(0.95); }
  .node:hover rect { stroke-width: 2px; }
  .tooltip {
    position: absolute; background: rgba(25, 45, 35, 0.95); color: white;
    padding: 12px 16px; border-radius: 8px; font-size: 14px; max-width: 250px;
    pointer-events: none; opacity: 0; transition: opacity 0.2s, transform 0.2s;
    transform: translateY(10px); z-index: 100; box-shadow: 0 4px 15px rgba(0,0,0,0.2);
  }
  .tooltip.show { opacity: 1; transform: translateY(0); }
</style>
<div class="svg-container">
  <svg width="100%" viewBox="0 0 800 250">
    <defs>
      <marker id="arrow" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
        <path d="M0 1L8 5L0 9" fill="none" stroke="var(--arrow-color)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      </marker>
    </defs>
    <!-- Example Arrow -->
    <path d="M 230 125 L 320 125" fill="none" stroke="var(--arrow-color)" stroke-width="1.5" stroke-dasharray="5 5" marker-end="url(#arrow)"/>
    <!-- Example Node -->
    <g class="node" data-tooltip="[Tooltip text goes here]">
      <rect x="30" y="90" width="200" height="70" rx="8" fill="var(--box-purple-bg)" stroke="var(--box-purple-border)" stroke-width="1"/>
      <text x="130" y="115" font-family="sans-serif" font-size="16" font-weight="bold" fill="var(--box-purple-border)" text-anchor="middle">Title</text>
      <text x="130" y="135" font-family="sans-serif" font-size="13" fill="#666" text-anchor="middle">Subtitle</text>
    </g>
  </svg>
</div>
